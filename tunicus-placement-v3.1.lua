--[[
	...
	V3.1 Made 14/7/2022 - glitchifyed
	Modified by glitchifyed (V3-V3.1)
	V2 Model link: https://www.roblox.com/library/1122124371
	V3.1 Model link: https://www.roblox.com/library/7980966840
	...
	V3.1 Github: https://github.com/glitchifyed/Tunicus-Placement-v3
		...
		if (model.PrimaryPart) then
			...
			for i = 1, #currentObjects do
				...
				if (not object.collision) then
					...
					local y0 = object.model:GetAttribute("y") * currentPlane.grid
